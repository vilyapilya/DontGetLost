...
Member1 = GroupMember.create(user_id: User1.id, group_id: User2.id)
Member2 = GroupMember.create(user_id: User1.id, group_id: User3.id)
Member3 = GroupMember.create(user_id: User1.id, group_id: User4.id)
Member4 = GroupMember.create(user_id: User2.id, group_id: User3.id)
Member5 = GroupMember.create(user_id: User2.id, group_id: User4.id)
Member6 = GroupMember.create(user_id: User2.id, group_id: User5.id)
Member7 = GroupMember.create(user_id: User3.id, group_id: User1.id)
Member8 = GroupMember.create(user_id: User3.id, group_id: User2.id)
Member9 = GroupMember.create(user_id: User3.id, group_id: User4.id)
Member10 = GroupMember.create(user_id: User4.id, group_id: User5.id)
Member11 = GroupMember.create(user_id: User4.id, group_id: User6.id)
Member12 = GroupMember.create(user_id: User4.id, group_id: User1.id)
Member13 = GroupMember.create(user_id: User5.id, group_id: User1.id)
Member14 = GroupMember.create(user_id: User5.id, group_id: User2.id)
Member15 = GroupMember.create(user_id: User5.id, group_id: User6.id)
Member16 = GroupMember.create(user_id: User6.id, group_id: User3.id)
Member17 = GroupMember.create(user_id: User6.id, group_id: User4.id)
Member18 = GroupMember.create(user_id: User6.id, group_id: User5.id)
